...
def cleanup_and_restore():
    ...
    print(f"Cleaning up and restoring 'users' table in: {schema}")
    ...
    with connection.cursor() as cursor:
        try:
            ...
            # Indices are dropped with table usually, but explicit drop to be safe if orphaned
            # Note: DROP INDEX IF EXISTS only works if index exists
